  ...
  return (
    <Product product={product}>
      <div data-aos="fade-up" className="item" key={product?.id}>
        <div className="w-full h-full bg-white relative group overflow-hidden py-4"
          style={{ boxShadow: "0px 15px 64px 0px rgba(0, 0, 0, 0.05)" }}
        >
          <Product.Link>
            <div className="w-full z-0 relative h-[240px]">
              <Product.Image />
            </div>
          </Product.Link>
          <div className="px-[30px] relative mt-[30px]">
            ...
            <Product.Price priceClassName="text-[18px]" discountedPriceClassName="text-[18px]" />
          </div>
